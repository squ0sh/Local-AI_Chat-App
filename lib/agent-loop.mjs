...
export async function executeTool(name, args, workspaceRoot, { autonomy, signal, readonly } = {}) {
...
// draft from shipping.
async function runCriticPasses(draft, { task, readonly, llmCall, onEvent, iteration }) {
  ...
  while (iteration < MAX_ITERATIONS) {
    ...
    if (toolCalls.length === 0) {
      ...
      if (critic && cleanContent) {
        ...
        try { final = await runCriticPasses(cleanContent, { task, readonly, llmCall, onEvent, iteration }); }
        catch (e) {
